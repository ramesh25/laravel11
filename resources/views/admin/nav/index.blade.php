...
<div class="flex justify-between items-center mb-4">
  <!-- Left side: Back Button + Create Button-->
  <div class="space-x-2">
    @if(isset($parent_id))
    <!-- Back Button -->
    ...
    <!-- Create Button -->
    <a href="{{ route('nav.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded hover:bg-blue-700 transition">
      <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
  ...
  <div class="relative inline-block text-left">
    ...
    <div id="actionDropdown" class="hidden absolute right-0 mt-2 w-40 bg-white border rounded shadow-lg z-50">
      <a href="javascript:void(0);" onclick="return actionSubmit('{{ url('admin/nav/update-publish/1') }}');" class="text-gray-700 block px-4 py-2 text-sm hover:bg-gray-100" role="menuitem">Publish</a>
      <a href="javascript:void(0);" onclick="return actionSubmit('{{ url('admin/nav/update-publish/0') }}');" class="text-gray-700 block px-4 py-2 text-sm hover:bg-gray-100" role="menuitem">Unpublish</a>
      <a href="javascript:void(0);" onclick="return actionConfirm('{{ url('admin/nav/bulk_delete') }}','Delete');" class="block px-4 py-2 text-sm text-red-600 hover:bg-red-100" role="menuitem">Delete</a>
    </div>
  </div>
</div>
