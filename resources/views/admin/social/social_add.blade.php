  ...
  <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
    ...
    <div class="md:col-span-8">
      <div class="bg-white p-6 rounded shadow">
        ...
        <div class="mb-4">
          ...
          <input type="text" name="icon" value="{{ old('icon') }}" class="w-full border rounded px-4 py-2 focus:ring focus:border-blue-400" placeholder="class of icon">
        ...
        <div class="mb-4">
          ...
          <input type="text" name="link" value="{{ old('link') }}" class="w-full border rounded px-4 py-2 focus:ring focus:border-blue-400" placeholder="enter your social media link">
    ...
    <div class="md:col-span-4">
      <div class="bg-white p-6 rounded shadow">
        ...
        <div class="mt-6">
          <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700">Save Social</button>
        </div>
