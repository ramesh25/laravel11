...
<div class="flex justify-between items-center mb-4">
  ...
  <div class="space-x-2">
    <!-- Back Button -->
    <a href="{{ url('admin/social') }}" class="inline-flex items-center px-4 py-2 bg-cyan-600 text-white text-sm font-medium rounded hover:bg-cyan-700 transition">
...
<form action="{{ route('social.update', $model->id) }}" method="POST" enctype="multipart/form-data">
  @csrf
  @method('PUT')
  <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
    ...
    <div class="md:col-span-8">
      <div class="bg-white p-6 rounded shadow">
        ...
        <div class="mb-4">
          ...
          <input type="text" name="icon" value="{{ old('icon', $model->icon) }}" class="w-full border rounded px-4 py-2 focus:ring focus:border-blue-400" placeholder="class of icon">
        ...
        <div class="mb-4">
          ...
          <input type="text" name="link" value="{{ old('link', $model->link) }}" class="w-full border rounded px-4 py-2 focus:ring focus:border-blue-400" placeholder="enter your social media link">
    ...
    <div class="md:col-span-4">
      <div class="bg-white p-6 rounded shadow">
        ...
        <div class="mt-6">
          <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700">Update Social</button>
        </div>
