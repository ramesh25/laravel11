    ...
    <div class="md:col-span-8">
      <div class="bg-white p-6 rounded shadow">
        ...
        <div class="mb-4">
          ...
          <input type="text" name="name" value="{{ old('name') }}" class="w-full border rounded px-4 py-2 focus:ring focus:border-blue-400" required>
        ...
        <div class="mb-4">
          ...
          <input type="email" name="email" value="{{ old('email') }}" class="w-full border rounded px-4 py-2 focus:ring focus:border-blue-400" required>
        ...
        <div class="mb-4">
          ...
          <input type="number" name="phone" value="{{ old('phone') }}" class="w-full border rounded px-4 py-2 focus:ring focus:border-blue-400" required>
        ...
        <div class="mb-4">
          ...
          <textarea name="detail" rows="3" class="w-full border rounded px-4 py-2 focus:ring focus:border-blue-400">{{ old('detail') }}</textarea>
