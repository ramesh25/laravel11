  ...
  <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
    ...
    <div class="md:col-span-6">
      <div class="bg-white p-6 rounded shadow">
        <h2 class="text-lg font-semibold text-gray-700 mb-4">Create Admin</h2>

        <!-- Fullname -->
        <div class="mb-4">
          <label class="block text-sm font-medium text-gray-700 mb-1">Fullname : {{ $model->name }}</label>
        </div>

        <!-- Email -->
        <div class="mb-4">
          <label class="block text-sm font-medium text-gray-700 mb-1">Email : {{ $model->email }}</label>
        </div>

        <!-- Phone -->
        <div class="mb-4">
          <label class="block text-sm font-medium text-gray-700 mb-1">Phone : {{ $model->phone }}</label>
        </div>
        <!-- Phone -->
        <div class="mb-4">
          <label class="block text-sm font-medium text-gray-700 mb-1">Short Info : {{ $model->detail }}</label>
        </div>
        <!-- Image -->
        <div class="mb-4">
          <label class="block text-sm font-medium text-gray-700 mb-1">Image</label>
            <div class="col-sm-3">
              <a class="image_zoom lumos-link" data-lumos="gallery1" href="{{ asset($model->upload.$model->image) }}"></a>
              <img src="{{ asset($model->upload.$model->image) }}" class="img-thumbnail image_list" style="width: 150px; height: 80px;" /><br>
          </div>
        </div>
      ...
      <div class="bg-white p-6 rounded shadow mt-6">
        ...
        <div class="mb-4 md:flex md:items-start">
          <label for="old_password" class="md:w-1/4 font-medium text-gray-700">Old Password</label>
          <div class="md:w-3/4">
        ...
        <div class="mb-4 md:flex md:items-start">
          <label for="new_password" class="md:w-1/4 font-medium text-gray-700">Password</label>
          <div class="md:w-3/4">
