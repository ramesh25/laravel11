...
<div class="flex justify-between items-center mb-4">
  ...
  <div class="relative inline-block text-left">
    ...
    <div id="actionDropdown" class="hidden absolute right-0 mt-2 w-40 bg-white border rounded shadow-lg z-50">
      <a href="javascript:void(0);" onclick="return actionSubmit('{{ url('admin/advertise/update-publish/1') }}');" class="text-gray-700 block px-4 py-2 text-sm hover:bg-gray-100" role="menuitem">Publish</a>
      <a href="javascript:void(0);" onclick="return actionSubmit('{{ url('admin/advertise/update-publish/0') }}');" class="text-gray-700 block px-4 py-2 text-sm hover:bg-gray-100" role="menuitem">Unpublish</a>
      <a href="javascript:void(0);" onclick="return actionConfirm('{{ url('admin/advertise/bulk_delete') }}','Delete');" class="block px-4 py-2 text-sm text-red-600 hover:bg-red-100" role="menuitem">Delete</a>
    </div>
  </div>
</div>
...
<div class="bg-white shadow rounded-lg p-6">
  <div class="flex justify-between items-center mb-4">
    <h2 class="text-lg font-semibold text-gray-700">Advertise List</h2>
