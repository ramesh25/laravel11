...
<form action="{{ route('page.update', $model->id) }}" method="POST" enctype="multipart/form-data">
  @csrf
  @method('PUT')
  <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
    ...
    <div class="md:col-span-4">
      <div class="bg-white p-6 rounded shadow">
        ...
        <div class="mt-6">
          <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700">Update Page</button>
        </div>
