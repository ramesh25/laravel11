...
<div class="flex justify-between items-center mb-4">
  ...
  <div class="space-x-2">
    <!-- Create Button -->
    <a href="{{ route('roles.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded hover:bg-blue-700 transition">
...
<div class="bg-white shadow rounded-lg p-6">
  <div class="flex justify-between items-center mb-4">
    <h2 class="text-lg font-semibold text-gray-700">Role List</h2>
    ...
    <table class="min-w-full divide-y divide-gray-200" id="userTable">
      <thead class="bg-gray-50">
        <tr>
          ...
          <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Roles Name</th>
      ...
      <tbody class="bg-white divide-y divide-gray-200" id="tableBody">
        ...
        <tr>
          ...
          <td class="px-4 py-2 text-right space-x-2">
            <a href="{{ route('roles.edit', $m->id) }}" class="px-3 py-1 bg-blue-500 text-white text-xs rounded hover:bg-blue-600">Edit</a>
            <a title="Delete Item" onclick="javascript:return confirm('Are you sure to delete ?')" href="{{ url('admin/roles/delete', $m->id) }}" class="px-3 py-1 bg-red-500 text-white text-xs rounded hover:bg-red-600"><i class="mdi mdi-delete"></i>Delete</a>
          </td>
        </tr>
        @endforeach
